...
def _get_dictionary(obj, replacements):
    ...
    for attr_name in dir(obj):
        ...
        try:
            ...
            if inspect.isroutine(attr_value) or isinstance(
                attr_value, MethodWrapperType
            ):
                continue
...
class PandasDataFrameTypeResolveProvider(object):
    def can_provide(self, type_object, type_name):
        ...
        return data_frame_class is not None and issubclass(
            type_object, data_frame_class
        )
