...
class IPKernelApp(BaseIPythonApplication, InteractiveShellApp, ConnectionFileMixin):
    ...
    def abs_connection_file(self):
        if (
            Path(self.connection_file).name == self.connection_file
            and self.connection_dir
        ):
    ...
    def init_connection_file(self):
        ...
        try:
            ...
            Path(self.abs_connection_file).parent.mkdir(
    ...
    def log_connection_info(self):
        ...
        if (
            not self.parent_handle and int(self.log_level) < logging.CRITICAL
    ...
    def initialize(self, argv=None):
        ...
        try:
            ...
            if int(self.log_level) < logging.CRITICAL:  # type:ignore[call-overload]
                self.log.error(
                    "Unable to initialize signal:", exc_info=True
                )  # noqa: G201
        self.init_kernel()
        # shell init steps
        self.init_path()
