...
def _accepts_parameters(meth, param_names):
    ...
    for param in param_names:
        ...
        accepts[param] = (
            param_spec
            and param_spec.kind
            in [param_spec.KEYWORD_ONLY, param_spec.POSITIONAL_OR_KEYWORD]
...
class Kernel(SingletonConfigurable):
    ...
    async def process_control(self, msg):
        ...
        if handler is None:
            ...
            try:
                ...
                self.log.error(
                    "Exception in control handler:", exc_info=True
                )  # noqa: G201
    ...
    def enter_eventloop(self):
        ...
        def schedule_next():
            ...
            self.io_loop.call_later(
                0.001, partial(self.schedule_dispatch, advance_eventloop)
            )
    ...
    async def usage_request(self, stream, ident, parent):
        ...
        self.processes = {
            process.pid: self.processes.get(
                process.pid, process
        ...
        if (
            cpu_percent is not None and cpu_percent != 0.0
    ...
    def _send_abort_reply(self, stream, msg, idents):
        ...
        if not self.session:
            return
        self.log.info(
            "Aborting %s: %s", msg["header"]["msg_id"], msg["header"]["msg_type"]
        )
