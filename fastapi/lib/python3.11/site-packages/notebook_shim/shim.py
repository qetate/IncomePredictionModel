...
class NotebookConfigShimMixin:
    ...
    def shim_config_from_notebook_to_jupyter_server(self, config):
        ...
        extapp_traits = (
            self.__class__.class_trait_names() + ExtensionApp.class_trait_names()
        )
        svapp_traits = ServerApp.class_trait_names()
        nbapp_traits = (
            NotebookAppTraits.class_trait_names() + ExtensionApp.class_trait_names()
        )
