...
_ArrayLike1DInt_co = _SupportsArray[np.dtype[_Int_co]] | Sequence[int | _Int_co]
_ArrayLike1DFloat_co = (
    _SupportsArray[np.dtype[_Float_co]] | Sequence[float | int | _Float_co]
)
_ArrayLike2DFloat_co = (
    _SupportsArray[np.dtype[_Float_co]] | Sequence[_ArrayLike1DFloat_co]
)
_ArrayLike1DNumber_co = (
    _SupportsArray[np.dtype[_Number_co]] | Sequence[int | float | complex | _Number_co]
)
